...
public:
	...
	//friend bool operator == (playerNode& n1,playerNode& n2); //{ return ((n1.getUserName() == this->getUserName()) && (getPassword() == this->getPassword())); }

	//
	bool operator < (playerNode& n1) { return (this->getScore() < n1.getScore()); }
